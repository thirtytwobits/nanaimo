...
templates_path = ['docs/static/templates']
...
html_logo = 'docs/static/images/nanaimo_title.png'

html_favicon = 'docs/static/images/32bit_logo.png'
...
latex_documents = [
    (master_doc, 'nanaimo.tex', 'nanaimo Documentation',
     'Amazon.com', 'manual'),
]
